...
class MaxDigitViewController: UIViewController, MaxDigitView {
    var presenter: MaxDigitPresenter!
    ...
    override func loadView() {
        maxDigitView.backgroundColor = .white
        ...
        maxDigitView.addSubview(containerView)
...
private typealias PrivateMaxDigitViewController = MaxDigitViewController
private extension PrivateMaxDigitViewController {
